...
class TimeAndEventListCustomLayout extends StatelessWidget {
  ...
  TimeAndEventListCustomLayout(
      {required this.listOfEvents, required this.onTapEvent});
        ...
        child: ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              return GestureDetector(
                  ...
                  child: TimeAndEventListEachItem(
                    eventsItem: listOfEvents[index],
                  ));
            }),
      ),
    );
...
class TimeAndEventListEachItem extends StatelessWidget {
  ...
  TimeAndEventListEachItem({required this.eventsItem});
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              TimeLineView(
                activeTimeLineFlag: eventsItem.currentTimeFlag,
              ),
              SizedBox(
                width: MARGIN_MEDIUM,
              ),
        ...
        children: [
          Padding(
            ...
            child: Container(
              ...
              width: 35,
              decoration: BoxDecoration(
                color: eventsItem.currentTimeFlag == true
                    ? Color.fromRGBO(248, 251, 255, 1)
                    : Color.fromRGBO(233, 235, 249, 1),
...
class TimeLineView extends StatelessWidget {
  ...
  TimeLineView({required this.activeTimeLineFlag});
...
class TimeView extends StatelessWidget {
  ...
  TimeView({required this.eventsItem});
